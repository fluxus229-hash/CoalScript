...
local function createSlider(yPos, name, min, max, callback)
    ...
    btn.Size = UDim2.new(1, 0, 1, 0); btn.BackgroundTransparency = 1; btn.Text = name
...
playerList.Size = UDim2.new(0.4, 0, 0, 100); playerList.Position = UDim2.new(0.55, 0, 0, 20)
...
local function refreshPlayerList()
    ...
    for _, p in pairs(game.Players:GetPlayers()) do
        if p ~= player then
            ...
            btn.Size = UDim2.new(1, -5, 0, 25); btn.Text = p.Name
...
aimButton.Size = UDim2.new(0.4, 0, 0, 40); aimButton.Position = UDim2.new(0.05, 0, 0, 20)
aimButton.Text = "Toggle Aim"
aimButton.MouseButton1Click:Connect(function() 
    isAiming = not isAiming 
    aimButton.BackgroundColor3 = isAiming and Color3.new(0, 1, 0) or Color3.new(0.8, 0.2, 0.2)
end)
